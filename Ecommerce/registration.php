...
<body>
<form name="form1" id="form1" method="post" action="regprocess.php" onsubmit="return userlogin();">
...
<table width="100%" border="0" cellspacing="2" cellpadding="1">
  ...
  <tr>
    ...
    <td align="center"><a class="style1" href="homepage.php" >Home</a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="3">&nbsp;</td>
    <td>&nbsp;<input type="submit" name="S1" id="S1" tabindex="4" value="Registration" onclick="return userlogin();" /></td>
    <td>&nbsp;</td>
  </tr>
</table>
